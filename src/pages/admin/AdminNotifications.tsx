...
const AdminNotifications = () => {
  const plannedFeatures = [
    { icon: Mail, title: "Email Templates", description: "Manage system email templates and notifications" },
    { icon: MessageSquare, title: "Push Notifications", description: "Send targeted notifications to users" },
    { icon: Settings, title: "Notification Rules", description: "Configure automated notification triggers" },
  ];
        ...
        <Card className="bg-admin-card border-admin-border">
          <CardHeader className="text-center pb-2">
            <div className="mx-auto h-16 w-16 rounded-2xl bg-admin-muted flex items-center justify-center mb-4">
              <Bell className="h-8 w-8 text-admin-foreground" />
            </div>
            <CardTitle className="text-2xl text-admin-foreground">Notifications</CardTitle>
          ...
          <CardContent className="space-y-6">
            <p className="text-center text-admin-muted-foreground">
              Manage notification settings, email templates, and user communications.
            </p>
