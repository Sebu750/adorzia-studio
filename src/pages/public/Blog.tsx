        ...
        <div className="max-w-7xl mx-auto px-6 relative">
          <div className="text-center max-w-2xl mx-auto">
            ...
            >
              ...
              <AnimatedHeading className="font-display text-4xl md:text-5xl lg:text-6xl font-bold mb-6 tracking-tight">
              ...
              >
                <Link to={`/blog/${post.id}`}>
                  <TiltCard tiltAmount={6}>
                    <Card className="h-full overflow-hidden group cursor-pointer hover:shadow-lg transition-shadow bg-background">
