...
import { Badge } from "@/components/ui/badge";
import { Users, UserCheck, Trophy, BarChart3 } from "lucide-react";

const AdminTeams = () => {
  const plannedFeatures = [
    { icon: UserCheck, title: "Team Management", description: "View and manage designer teams" },
    { icon: Trophy, title: "Team Challenges", description: "Monitor team challenge progress and submissions" },
    { icon: BarChart3, title: "Team Analytics", description: "Track team performance and collaboration metrics" },
  ];
        ...
        <Card className="bg-admin-card border-admin-border">
          <CardHeader className="text-center pb-2">
            <div className="mx-auto h-16 w-16 rounded-2xl bg-admin-muted flex items-center justify-center mb-4">
              <Users className="h-8 w-8 text-admin-foreground" />
            </div>
            <CardTitle className="text-2xl text-admin-foreground">Teams</CardTitle>
          ...
          <CardContent className="space-y-6">
            <p className="text-center text-admin-muted-foreground">
              Manage designer teams, monitor team challenges, and track collaboration.
            </p>
