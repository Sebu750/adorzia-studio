...
export const VISIBILITY_TAG_OPTIONS = [
  'Visible to Senior Designers Only',
  'Educational License',
  'Internal Only',
  'Public Marketplace',
  'Visible to Apprentice Rank',
  'Visible to Patternist Rank',
  'Visible to Stylist Rank',
  'Visible to Couturier Rank',
  'Visible to Visionary Rank',
  'Visible to Creative Director Rank',
  'Visible to F1 Rank',
  'Visible to F2 Rank',
];
